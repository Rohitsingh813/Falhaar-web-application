        ...
        <div class="row">
            <div class="col-sm-4 col-12 filter-box">
                ...
                <div class="row filter-section">
                    <ul class="filter-option">
                        <li>
                            <input type="button" name="rPrice" id="rtfPrice" value="200,500" hidden
                        ...
                        <li>
                            <input type="button" name="rPrice" id="rftPrice" value="500,100" hidden
                                @click="filterPriceBtn($event)" />
                        ...
                        <li>
                            <input type="button" name="rPrice" id="ltPrice" value="200" hidden
                                @click="filterPriceBtn($event)" />
