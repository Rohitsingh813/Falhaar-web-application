        ...
        <div class="checkout-form-container">
            <form id="checkoutForm" @submit="handleSubmit" novalidate autocomplete="off">
                ...
                <div class="form-group details-group">
                    ...
                    <div class="form-group">
                        <input type="text" name="coAddress" id="coAddress" placeholder="Address in india, Pune"
...
if (!this.checkoutObj.phone) {
    ...
    if (!this.checkoutObj.phone.startsWith('0') &&!this.checkoutObj.phone.startsWith('91')) {
        this.errorObj.phoneErr.push('Phone numbers must start with 0 or 91');
    }
